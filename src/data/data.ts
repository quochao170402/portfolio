import { EducationItem, ExperienceItem, Profile, ProjectItem, Skills } from '../types';
...
export const profile: Profile = {
  ...
  summary: "Results-driven Software Engineer with 3.5 years of experience building scalable backend systems and modern frontend applications. Expert in .NET ecosystem, microservices, and cloud technologies (GCP/Azure). Proven track record in fintech, delivering high-performance solutions and leading infrastructure migrations.",
  shortSummary: "Results-driven Software Engineer with 3.5 years of experience building scalable backend systems and modern frontend applications. Expert in .NET ecosystem, microservices, and cloud technologies (GCP/Azure).",
  social: {
...
export const skills: Skills = {
  backend: ["Net Core", ".NET Framework", "Entity Framework", "C#", "RabbitMQ", "MassTransit"],
  frontend: ["TypeScript", "React", "React Native", "TailwindCSS", "Ant Design"],
  database: ["SQL Server", "PostgreSQL", "MongoDB", "Redis", "Elasticsearch"],
  architecture: ["Microservices", "Clean Architecture", "DDD", "TDD", "Event-Driven"],
...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    tech: [".NET Core", "React", "TailwindCSS", "Microservices", "System Design"]
  },
  {
    company: "Freelance",
  ...
  },
  {
    ...
    tech: [".NET Core", "RabbitMQ", "Microservices", "DDD", "Clean Architecture"]
  },
  {
    company: "HAHAHO JSC",
...
export const projects: ProjectItem[] = [
  {
    ...
    company: "Herond Labs",
    description: "Comprehensive fintech platform handling transaction management and compliance for enterprise clients.",
    longDescription: "A high-scale enterprise fintech platform designed to handle complex transaction flows, compliance checking, and real-time reporting. The system was built to ensure 99.99% availability and strict data consistency across distributed services.",
  ...
  },
  {
    ...
    description: "Production-grade financial website deployed on Linux VPS with automated CI/CD pipelines.",
    longDescription: "A secure and responsive financial trading portal built for high-speed data access and trading execution. The infrastructure was containerized to ensure consistent deployments and easy scalability during market peaks.",
  ...
  },
  {
    ...
    company: "Client Project",
    description: "Music management system with complex metadata handling and optimized database schemas.",
    longDescription: "A specialized backend system for managing vast libraries of music metadata. It handles complex relationships between artists, albums, tracks, and copyrights, ensuring fast search and retrieval times.",
  ...
  },
  {
    ...
    longDescription: "An interactive dashboard that visualizes complex business data and uses ML models to predict future trends. Built with a focus on performance and data visualization best practices.",
  ...
  },
  {
    ...
    longDescription: "A feature-rich mobile app offering a seamless shopping experience. Includes an innovative AR try-on feature allowing users to visualize products before purchase.",
  ...
  },
  {
    ...
    description: "IoT control panel for managing smart home devices with voice integration.",
    longDescription: "A centralized hub for controlling various smart home protocol devices. Integates with Alexa and Google Home for voice commands and provides automation routines.",
  ...
  },
  {
    ...
    description: "Blockchain-based supply chain transparency tool for logistics companies.",
    longDescription: "Leverages blockchain technology to provide immutable records of product journey from manufacture to delivery, ensuring authenticity and transparency.",
  ...
  },
  {
    ...
    description: "HIPAA-compliant system for remote patient monitoring and doctor communication.",
    longDescription: "A secure platform allowing doctors to monitor vital signs of patients remotely in real-time. Built with strict adherence to security and privacy regulations.",
